...
const Admin: React.FC = () => {
  ...
  // [MOVED] Login screen return moved to bottom to prevent Hook errors
  ...
  const toggleSpecialty = (type: 'Lash' | 'Brow' | 'Lip' | 'Care') => {
    setStylistForm(prev => {
      const specs = prev.specialties || [];
      if (specs.includes(type)) return { ...prev, specialties: specs.filter(s => s !== type) };
      return { ...prev, specialties: [...specs, type] };
    });
  };
