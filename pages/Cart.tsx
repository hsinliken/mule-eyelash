...
const Cart: React.FC = () => {
  ...
  return (
    <div className="pb-32 bg-brand-50/30 min-h-screen">
      ...
      <div className="fixed bottom-[70px] left-0 right-0 bg-white/90 backdrop-blur-md border-t border-brand-100 p-4 z-40 max-w-md mx-auto shadow-lg">
        <div className="flex justify-between items-center mb-3">
          <span className="text-brand-500 text-sm">小計</span>
